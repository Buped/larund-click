...
import {
  ...
  siSupabase, siVercel, siLinear, siDiscord, siTrello, siJira, siShopify,
  siStripe, siX, siMeta, siInstagram, siFacebook, siGoogleads, siGoogleanalytics,
  siGooglesearchconsole, siMailchimp, siWebflow, siFramer, siNetlify, siSentry,
  siCloudflare, siResend, siBrevo, siLangchain,
} from 'simple-icons';
...
export const PROVIDER_ICONS: Record<string, BrandIconData> = {
  ...
  'facebook-pages': si(siFacebook),
  facebook: si(siFacebook),
  'google-ads': si(siGoogleads),
  ga4: si(siGoogleanalytics),
  'google-analytics': si(siGoogleanalytics),
