...
export const ACTION_TEMPLATES = [
  ...
  { type: "click",      icon: "pointer",  color: "var(--accent)", text: 'Clicked "Email address" field at (612, 318)',   detail: "Confidence: 97%" },
  { type: "type",       icon: "keyboard", color: "#3ECF8E", text: 'Typed "alex@larund.io"',                        detail: "28 keystrokes · field focused" },
  { type: "click",      icon: "pointer",  color: "var(--accent)", text: 'Clicked "Company" field at (612, 392)',         detail: "Confidence: 95%" },
